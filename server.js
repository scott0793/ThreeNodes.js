...
function respondFunction(req,res){
	...
	if (query == "List") {
		...
		// I should here also have the token secret to send to aimlogin
//		console.log("I am in cslogin2 and will execute 'aimlogin oauth1 " + query + "'");
//		console.log(req.session.oauthsecret);
